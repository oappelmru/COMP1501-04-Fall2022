...
5. **Commit** the staged changes with:
    ```bash
...
That's it! Go back to the original URL that you copied in Part 1 and refresh the page. You should see your new `answer.md` file and the updated README.
